# jobs-DashBoard
V📊 Data Jobs Dashboard – Power BI Project (2 Reports)
...
We use a single dataset of real 2025 data job postings (including titles, salaries, job types, skills, locations), and deliver two different reports within the same project, each tailored for a specific type of exploration:
